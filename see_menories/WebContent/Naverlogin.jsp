...
<%@ page import="model.NaverResponse"%>
...
<%
	...
	String redirectURI = URLEncoder.encode("http://localhost:8090/see_memories/naverlogin.jsp", "UTF-8");
	String apiURL;
	apiURL = "https://nid.naver.com/oauth2.0/token?grant_type=authorization_code&";
	apiURL += "client_id=o9dAOzmlu2HUZ5xiLfhj"; //애플리케이션 클라이언트 아이디값";
	apiURL += "&client_secret=K3r_Ca8fMe"; //애플리케이션 클라이언트 시크릿값";
